...
public class PropertiesConfig
{
	...
	{
		// 获取绝对路径
		filePath = PropertiesConfig.class.getClassLoader().getResource(filePath).toString();
		// 截掉路径的”file:“前缀
...
//	{
//		System.out.println(PropertiesConfig.readData("resource.properties", "sys.periodCount"));
//		PropertiesConfig.writeData("resource.properties", "sys.periodCount", "11");
//	}
}